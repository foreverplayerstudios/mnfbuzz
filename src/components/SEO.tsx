...
export const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      'https://facebook.com/movienightfree',
      'https://twitter.com/movienightfree',
      'https://instagram.com/movienightfree',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer support',
      email: 'contact@movienightfree.buzz'
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:site" content="@movienightfree" />
      <meta name="twitter:creator" content="@movienightfree" />
      ...
      {publishedAt && <meta property="article:author" content="MovieNightFree" />}

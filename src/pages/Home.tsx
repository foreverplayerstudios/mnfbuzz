...
export const Home = () => {
  ...
  const metaDescription = trendingMovies && trendingMovies.length > 0
    ? `Stream the latest movies and TV shows in HD quality on MovieNightFree. Now trending: ${trendingMovies.slice(0, 3).map(m => m.title).join(', ')}. Watch your favorite content anytime, anywhere.`
    : "Stream the latest movies and TV shows in HD quality on MovieNightFree. Watch your favorite content anytime, anywhere. Free streaming of popular movies and TV series.";
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0f0f0f]">
        <h1 className="sr-only">MovieNightFree - Watch Movies & TV Shows Online</h1>

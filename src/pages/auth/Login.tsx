...
export const Login = () => {
  ...
  return (
    <>
      <SEO
        title="Sign In - MovieNightFree"
        description="Sign in to your MovieNightFree account to access your watchlist and continue streaming your favorite movies and TV shows."
      />
